        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    ...
                    var status = {
                        1: {'title': '지불됨', 'class': ' label-light-primary'},
                        2: {'title': '승인중', 'class': ' label-light-danger'},
                        3: {'title': '연체', 'class': ' label-light-primary'},
                        4: {'title': '거절', 'class': ' label-light-success'}
                    };
                ...
                title: '토큰',
                template: function(row) {
                    var output = 'pk.eyJ1IjoiamFzb25zc2kiLCJhIjoiY2tkZTBwanM3MWdkdTJxdDFneXV4Njg4dyJ9.2RoHLMQqe9Tsurqf5E0k6g';
